...
<head>
    ...
    <meta name="description" content="Rent and Roooms">
    <meta name="author" content="">
    <meta name="generator" content="Jekyll">
    <title>Rent and Roooms</title>
    <!-- Google fonts -->
    <link
    ...
    <meta name="twitter:title" content="For Rent or To Let Join with Us">
    <meta name="twitter:description" content="Rent and Roooms">
    <meta name="twitter:image" content="images/homeid-social-logo.png">

    <!-- Facebook -->
    <meta property="og:title" content="For Rent or To Let Join with Us">
    <meta property="og:description" content="Rent and Roooms">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            checkboxes.forEach(checkbox => {
                checkbox.addEventListener('change', function() {
                    ...
                    dropdownButton.textContent = selectedRooms.length ? selectedRooms.join(', ') :
                        'Select Rooms';
                });
            });
        });
  ...
  <a href="https://wa.me/+0044771319672" target="_blank" class="popup-button">Chat Now</a>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const showLightbox = (imageSrc, index) => {
            ...
            prevBtn.addEventListener('click', () => {
                activeImageIndex = (activeImageIndex === 0) ? lightboxTriggers.length - 1 :
                    activeImageIndex - 1;
                const imgSrc = lightboxTriggers[activeImageIndex].getAttribute('data-imgsrc');
                showLightbox(imgSrc, activeImageIndex);
            });

            nextBtn.addEventListener('click', () => {
                activeImageIndex = (activeImageIndex === lightboxTriggers.length - 1) ? 0 :
                    activeImageIndex + 1;
                const imgSrc = lightboxTriggers[activeImageIndex].getAttribute('data-imgsrc');
                showLightbox(imgSrc, activeImageIndex);
            });
