...
<html lang="en">
  <head>
    ...
    <meta name="description" content="For Rent or To Let Join with Us">
    <meta name="author" content="">
    <meta name="generator" content="Jekyll">
    <title>Rent and Rooms | Admin</title>
    <!-- Google fonts -->
    ...
    <meta name="twitter:description" content="For Rent or To Let Join with Us">
    <meta name="twitter:image" content="images/homeid-social-logo.png">
    <!-- Facebook -->
    <meta property="og:url" content="dashboard.html">
    <meta property="og:title" content="Dashboard">
    <meta property="og:description" content="For Rent or To Let Join with Us">
                ...
                <ul class="list-group list-group-flush w-100">
                  <li class="list-group-item">
                    ...
                    <ul class="list-group list-group-no-border rounded-lg">
                      ...
                      @can('send-emails')
                      <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item" role="button" onclick="window.location='{{ route('send.mail') }}'" >
                        <a href="{{route('send.mail')}}" class="text-heading lh-1 sidebar-link">
                          <span class="sidebar-item-icon d-inline-block mr-3 fs-20"><i class="fad fa-envelope"></i></span>
                    ...
                    <ul class="list-group list-group-no-border rounded-lg">
                        ...
                        <div class="collapse" id="roles_collapse">
                            ...
                            <ul class="list-group list-group-flush list-group-no-border">
                                ...
                                <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                  <a class="text-heading lh-1 sidebar-link" href="{{route('role.in.permission')}}">Role In Permission</a>
                                  </li>
                                <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                ...
                <div class="container-fluid">
                  <nav class="navbar navbar-light py-0 row no-gutters px-3 px-lg-0">
                    ...
                    <div class="col-md-6 d-flex flex-wrap justify-content-md-end order-0 order-md-1">
                      <a href="{{ route('admin.bookings.create') }}" class="btn btn-link btn-sm text-primary py-2 px-3 d-flex align-items-center">
