                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <div>{{ \Carbon\Carbon::parse($booking->to_date)->format('d M Y') }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
    ...
    <div class="card mb-4 border-0 shadow-sm">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <a href="{{ route('admin.package.edit', ['packageId' => $package->id]) }}" class="btn btn-primary btn-sm">
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <a href="{{ $package->map_link }}" target="_blank" class="btn btn-sm btn-outline-primary mt-1">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mt-3">
                                            <div class="d-flex justify-content-between mb-2">
                                                ...
                                                <span class="badge bg-light text-dark">{{ $room->number_of_beds }}</span>
                                            </div>
                                            <div class="d-flex justify-content-between mb-3">
                                                <small class="text-muted">Bathrooms</small>
                                                <span class="badge bg-light text-dark">{{ $room->number_of_bathrooms }}</span>
                                            </div>
                                            @foreach($room->prices as $price)
                                                <div class="card bg-light border-0 mb-2">
                                                    <div class="card-body p-3">
                                                        <small class="text-muted d-block mb-2">{{ ucfirst($price->type) }} Rate</small>
                                                        ...
                                                        @if($price->discount_price)
                                                            <div class="d-flex justify-content-between mb-1">
                                                                ...
                                                                <strong class="text-success">£{{ $price->discount_price }}</strong>
                                                            </div>
                                                        @endif
                                                        @if($price->booking_price)
                                                            <div class="d-flex justify-content-between">
                                                                <span>Booking Price</span>
                                                                <strong class="text-primary">£{{ $price->booking_price }}</strong>
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div>
